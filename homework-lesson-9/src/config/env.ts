...
export const SEARCH_MCP_HOST = readStringEnv("SEARCH_MCP_HOST", "127.0.0.1");
export const SEARCH_MCP_PORT = readNumberEnv("SEARCH_MCP_PORT", 8901);
export const SEARCH_MCP_URL = readStringEnv("SEARCH_MCP_URL", `http://${SEARCH_MCP_HOST}:${SEARCH_MCP_PORT}`);
export const REPORT_MCP_HOST = readStringEnv("REPORT_MCP_HOST", "127.0.0.1");
export const REPORT_MCP_PORT = readNumberEnv("REPORT_MCP_PORT", 8902);
export const REPORT_MCP_URL = readStringEnv("REPORT_MCP_URL", `http://${REPORT_MCP_HOST}:${REPORT_MCP_PORT}`);
export const GITHUB_MCP_HOST = readStringEnv("GITHUB_MCP_HOST", "127.0.0.1");
export const GITHUB_MCP_PORT = readNumberEnv("GITHUB_MCP_PORT", 8904);
export const GITHUB_MCP_URL = readStringEnv("GITHUB_MCP_URL", `http://${GITHUB_MCP_HOST}:${GITHUB_MCP_PORT}`);
export const ACP_HOST = readStringEnv("ACP_HOST", "127.0.0.1");
export const ACP_PORT = readNumberEnv("ACP_PORT", 8903);
export const ACP_URL = readStringEnv("ACP_URL", `http://${ACP_HOST}:${ACP_PORT}`);
