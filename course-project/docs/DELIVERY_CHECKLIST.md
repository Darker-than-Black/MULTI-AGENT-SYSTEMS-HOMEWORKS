...
5. **Reference-матеріали з лекцій** (у `.claude/references/`) Claude Code підвантажує точково, на запит. Якщо потрібен патерн з лекції — попроси Claude знайти відповідний reference замість того, щоб розраховувати на його memory.